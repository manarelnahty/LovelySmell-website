...
export default async function ShopPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div className="bg-[#FAF9F6] text-on-background font-body-md text-body-md antialiased min-h-screen flex flex-col">
      ...
      <a aria-label="تواصل معنا عبر واتساب" className="fixed bottom-8 left-8 bg-[#111] text-white p-4 rounded-full shadow-lg z-50 hover:scale-105 transition-transform flex items-center justify-center min-w-[56px] min-h-[56px]" href="https://wa.me/201018580523" target="_blank" rel="noopener noreferrer">
