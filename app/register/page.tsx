      ...
      <div className="flex flex-col justify-center px-6 md:px-16 lg:px-24 xl:px-32 relative min-h-screen overflow-y-auto py-12">
        ...
        >
          ...
          <form className="space-y-6" action={formAction}>
            ...
            {state?.success && (
              <div className="p-3 bg-green-50 border-r-4 border-green-500 text-green-700 font-tajawal text-sm mb-4 animate-in fade-in slide-in-from-right-2">
                {state.success}
              </div>
            )}
            ...
            <div className="space-y-2 relative">
              <label className="font-tajawal text-sm text-[#2C2C2C] font-semibold" htmlFor="confirmPassword">
                تأكيد كلمة المرور
              </label>
              <input
                type={showPassword ? "text" : "password"}
                ...
                required
                minLength={6}
                className="w-full border-b border-[#D8D0C5] bg-transparent py-3 pr-2 text-[#2C2C2C] font-tajawal placeholder-[#A9A096] focus:outline-none focus:border-[#C4A36E] transition-colors duration-300"
