    ...
    <div className="bg-background text-on-background font-body-md text-body-md antialiased min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-8 md:pt-section-gap px-4 md:px-margin pb-8 md:pb-section-gap max-w-container-max mx-auto w-full">
        ...
        <div className="flex justify-center mt-stack-lg">
          <button aria-label="Load more products" className="border-[1.5px] border-secondary text-secondary hover:bg-secondary/5 font-label-sm text-label-sm px-10 py-3 rounded-full transition-colors flex items-center gap-2 min-h-[44px]">
            تحميل المزيد
      ...
      <a aria-label="تواصل معنا عبر واتساب" className="fixed bottom-8 left-8 bg-secondary text-on-secondary p-4 rounded-full shadow-[0_4px_20px_rgba(117,90,44,0.3)] z-50 hover:scale-105 transition-transform flex items-center justify-center min-w-[56px] min-h-[56px]" href="#">
